...
function Footer() {
  return (
    <footer className="w-full   ">
      <div className="lg:flex px-5 md:px-14 flex-col  pt-10 bg-red-700 text-white items-start lg:space-x-8 md:flex-row">
        <div className="w-full lg:w-2/5">
          <img className="py-3 fill-white" src={img14} alt="" />
          <p className="">
            ...
            dolor purus non enim praesent elem
          </p>
        </div>
        <div className="w-full  flex flex-wrap lg:flex-nowrap lg:w-3/5 lg:gap-1">
          <ul className="flex flex-col space-y-4 text-[14px] w-1/2 md:w-1/4 mt-7 leading-3">
